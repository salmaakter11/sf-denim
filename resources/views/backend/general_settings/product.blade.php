<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Product(পণ্যদ্রব্য)') }} <span class="absulute mt-6" id="sidebarsizefixer" onclick="sidebarsizefixer()">
        ...
        <div class="mx-auto w-full">
            <div class="px-4 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between">
                    ...
                    @can('productCreate')
                        <div>
                            <a x-data @click="$dispatch('open-modal',{name:'product'})"
                ...
                @livewire('backend.general.product_index')
            </div>
        </div>
        @push('css')
    ...
    <x-custom-modal name="product" title="Add a New product">
        ...
        <section class="bg-white dark:bg-gray-900">
            <div class="py-1 lg:py-1 px-4 mx-auto max-w-screen-2xl">
                ...
                @livewire('backend.general.product_create')
