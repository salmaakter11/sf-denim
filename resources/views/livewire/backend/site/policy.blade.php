            ...
            <div class="bg-white py-6 px-4 space-y-6 sm:p-6">
                <div>
                    <h3 class="text-lg leading-6 font-medium text-gray-900">
                        Update Site Policy Page
                    </h3>
                    <p class="mt-1 text-sm text-gray-500">
                        Use this form to create or Update Site Policy Page.
                    </p>
                </div>
                <x-auth-session-status class="mb-4" :status="session('sitesettings_policy')" />
                <div class="grid grid-cols-6 gap-6">
                    <div wire:ignore class="col-span-6">
                        <label for="policy" class="block text-sm font-medium text-gray-700">Policy:<span class="text-red-500">*</span>
                        </label>
                        <div>
                            <textarea wire:model="policy" id="policy"></textarea>
                        </div>
