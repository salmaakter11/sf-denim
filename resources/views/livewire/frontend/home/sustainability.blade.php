            ...
            <div class="elementor-section-wrap">
                    ...
                    <nav class="navbar">
                        <div class="container" >
                            <ul>
                                ...
                                <li><a href="{{ route('sustailability') }}" class="text-white active">Sustainability</a></li>
                ...
                <section class="main-body" style="padding-top: 20vh;">
                    <div class="container-xl">
                        <h1 class="text-24 text-blue text-bold"><b>Sustainability
                        </b></h1>
                        <p> {!! $sustailability->content !!}</p>                      
                    </div>
                </section>
            </div>
        </div>
